...
export const products: Product[] = [
  ...
  { id: 'prod-004', sku: 'LUM-R004', name: 'Platinum Emerald Art Deco Ring', description: 'Art Deco inspired emerald ring set in platinum.', longDescription: 'Drawing inspiration from the Art Deco era, this stunning ring features an emerald-cut emerald flanked by baguette diamonds, all set in platinum. The geometric design and premium materials make this a statement piece for discerning customers.', price: 420.00, category: 'rings', collection: 'heritage', metal: 'Platinum', stoneType: 'Emerald', weight: '4.5g', dimensions: '12mm head width', images: ['/featured3.jpg'], isNew: false, isFeatured: true, inStock: true, minOrder: 2 },
